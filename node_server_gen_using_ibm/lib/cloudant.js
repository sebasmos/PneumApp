...
// IMPORTANT: see 'create' function

const cloudant_id = process.env.CLOUDANT_ID || 'c612a48e-6c75-40f8-b275-f9958a5e1317-bluemix'
const cloudant_apikey = process.env.CLOUDANT_IAM_APIKEY || 'ZsLAVsrlV9wGcjI9PJxLWiCPkuItr7Tl2vnBQIjqidPj';
...
// ONLY ONE USED AND MODIFIED FROM THE IBM EXAMPLE
/**
 ...
 */
function create(type, value, userID) {
    return new Promise((resolve, reject) => {
        let itemId = uuidv4();
